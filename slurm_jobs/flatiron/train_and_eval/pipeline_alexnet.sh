#!/bin/bash
PARAM_FILE="alexnet.txt"
SAVE_FOLDER="results/"
MODEL_NAME=("alexnet1") #mode of the model, can be "standard" or "convnet" or "convnet2" //// "vone_convnet-layer1_norm" or vone_convnet-layer1_norm-relu_last
...
sbatch --array=1-${LINE_COUNT} submit_jobs_alexnet_gpu.sbatch ${ARRAY_INDEX} ${PARAM_FILE}
